...
# Load video
video = cv2.VideoCapture('videoThema1_2.mp4')
...
# Set the output file
output = cv2.VideoWriter('1_2encoder.avi', cv2.VideoWriter_fourcc(*'MJPG'), fps, size, False)
...
codec = []
pbar = tqdm(total=frameCount, desc="Processing frames")
...
while video.isOpened():
    ...
    width = int(frameWidth / 32)
    height = int(frameHeight / 32)
